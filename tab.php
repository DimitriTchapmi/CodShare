             ...
             <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td data-title="modifier ou supprimer"><a href="http://codshare.itinet.fr/smodifier.php"><button type="button" class="btn btn-warning">Modif.</button></a> <a href =""><button type="button" class="btn btn-danger">Supp.</button></a></td>
                  </tr>
                </tbody>
              </table>
